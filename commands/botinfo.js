...
**Discord.js Version:** ${Discord.version}
       `)
        .addField("What is MushroomStew", "MushroomStew is the beginnings of a rewrite of NerdBot (not using the cheaty program). For now he's just picking up some of NerdBots slack during the rewrite.") 
...
exports.help = {
    name: "botinfo",
    category: "Info",
    description: "Displays information about MushroomStew",
    usage: "botinfo",
    example: ""
};